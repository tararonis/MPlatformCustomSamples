...
rem rem Delete old
del ".\bin\x64\Debug\Playlist Sample.exe.manifest" /f /q
...
copy ..\..\..\Bin\Manifests\x64\[YourApplicationExeFile].exe.manifest ".\bin\x64\Debug\Playlist Sample.exe.manifest" /y 
