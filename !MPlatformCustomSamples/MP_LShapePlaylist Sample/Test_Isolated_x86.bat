...
rem Delete old
del ".\bin\x86\Debug\Playlist Sample.exe.manifest" /f /q
...
copy ..\..\..\Bin\Manifests\x86\[YourApplicationExeFile].exe.manifest ".\bin\x86\Debug\Playlist Sample.exe.manifest" /y 
