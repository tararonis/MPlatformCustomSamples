...
rem Delete old
del ".\bin\x86\Debug\Capture Playlist Sample.exe.manifest" /f /q
...
copy ..\..\..\Bin\Manifests\x86\[YourApplicationExeFile].exe.manifest ".\bin\x86\Debug\Capture Playlist Sample.exe.manifest" /y 

rem Run
cd .\bin\x86\Debug
"Capture Playlist Sample.exe"
