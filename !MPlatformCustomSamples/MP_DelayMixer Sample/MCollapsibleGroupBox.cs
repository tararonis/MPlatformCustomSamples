...
namespace MixerSample
{
	...
	/// </summary>
	[ToolboxBitmap(typeof(MCollapsibleGroupBox))]
	public class MCollapsibleGroupBox : GroupBox
	{
		#region Fields
		...
		public bool IsCollapsed
		{
			...
			{
				//remember fullsize
				if (this.Size.Height > m_FullSize.Height || this.Size.Width > m_FullSize.Width)
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(MixerSample.MCollapsibleGroupBox));
			this.SuspendLayout();
			// 
			// CollapsibleGroupBox
			// 
