...
{
  [DefaultProperty("Image"), ToolboxBitmap(typeof(MImageBox))]
  public partial class MImageBox : ScrollableControl
  {
  #region  Private Class Member Declarations  

	  private static int _minZoom = 10;

	  public static int MinZoom
	  {
		  get { return MImageBox._minZoom; }
	  }
	private static int _maxZoom = 500;
  ...
  #region  Protected Overridden Methods  
    ...
    protected override void OnMouseMove(MouseEventArgs e)
    {
      ...
      if (e.Button == MouseButtons.Right && this.AutoPan && this.Image != null)
      {
        if (!this.IsPanning)
        {
  ...
  #region  Public Properties  
    ...
    public int Zoom
    {
      ...
      set
      {
        if (value < MImageBox._minZoom)
          value = MImageBox._minZoom;
        else if (value > MImageBox._maxZoom)
          value = MImageBox._maxZoom;
