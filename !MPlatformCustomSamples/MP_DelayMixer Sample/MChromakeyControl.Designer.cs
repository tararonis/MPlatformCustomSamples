namespace MixerSample
{
	partial class MChromaKeyControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.mCollapsibleGroupBox1 = new MixerSample.MCollapsibleGroupBox();
			...
			this.mNumericSliderMaxTransparent = new MixerSample.MNumericSliderAdjust();
			this.mNumericSliderMinTransparent = new MixerSample.MNumericSliderAdjust();
			this.groupBoxExclude = new System.Windows.Forms.GroupBox();
			this.mNumericSliderExclTransp = new MixerSample.MNumericSliderAdjust();
			this.mNumericSliderExclPower = new MixerSample.MNumericSliderAdjust();
			this.groupBoxPower = new System.Windows.Forms.GroupBox();
			this.mNumericSliderPowerG = new MixerSample.MNumericSliderAdjust();
			this.mNumericSliderPowerR = new MixerSample.MNumericSliderAdjust();
			this.mNumericSliderPowerB = new MixerSample.MNumericSliderAdjust();
			this.groupBoxColors = new System.Windows.Forms.GroupBox();
			this.mNumericSliderColAlpha = new MixerSample.MNumericSliderAdjust();
			this.mNumericSliderColLuma = new MixerSample.MNumericSliderAdjust();
			this.mNumericSliderColPower = new MixerSample.MNumericSliderAdjust();
			this.mNumericSliderColRange = new MixerSample.MNumericSliderAdjust();
			this.mNumericSliderColChroma = new MixerSample.MNumericSliderAdjust();
			this.mImageBoxPreview = new MixerSample.MImageBox();
			this.mNumericSliderSmooth = new MixerSample.MNumericSliderAdjust();
			this.mNumericSliderColor = new MixerSample.MNumericSliderAdjust();
			this.mNumericSliderTranspar = new MixerSample.MNumericSliderAdjust();
			this.mNumericSliderPower = new MixerSample.MNumericSliderAdjust();
			...
			this.mImageBoxPreview.GridDisplayMode = MixerSample.ImageBoxGridDisplayMode.None;
